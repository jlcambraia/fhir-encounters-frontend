...
export function useFilters() {
	...
	// Função para abrir o modal do Save View
	const handleSaveView = () => {
		setIsSaveViewModalOpen(true);
	};

	// Função para salvar o na variável e em localStorage
	...
	// Função para fechar o modal do Save View
	const handleCloseSaveViewModal = () => {
		setIsSaveViewModalOpen(false);
	};

	// Função que seleciona o view salvo
	...
	// Função para submit do form
	const handleFormSubmit = (e) => {
		e.preventDefault();
		setPage(1);
	};

	// Função para reset do form
